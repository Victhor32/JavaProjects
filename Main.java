...
public class Main {
    ...
    //Using a switch statement print "Sunday, Monday .... Saturday" it the int parameter "day" is 0,1,...6
    //respectively, otherwise it should print "Invalid day"
    // Bonus
    // Write a second solution using the if then else, instead of using switch.
